import { Activity, Camera, Zap, Swords, Utensils, Code, Menu, Palette, Sparkles } from 'lucide-react';
...
export const Navigation = ({ activeTab, setActiveTab, mobileMenuOpen, setMobileMenuOpen, onLogout }: NavigationProps) => {
  ...
  const navItems = [
    ...
    { id: 'becomehero', label: 'Become Hero', icon: Sparkles },
          ...
          <div className="hidden lg:flex items-center space-x-2">
            {navItems.map(item => (
              <button
                ...
                className={`px-6 py-3 font-black uppercase text-sm tracking-wider border-4 border-border transition-all duration-200 hover:animate-jiggle ${activeTab === item.id
